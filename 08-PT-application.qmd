...
```{r}
#| label: tbl-HJ-T-8-1
#| tbl-cap: 'Learning from an instrument when patterns of confounding are specified: four $R=1, Y=1$ cases.'
#| echo: false
#| message: false
#| warning: false
...
```{r}
#| label: tbl-RSTD00
#| tbl-cap: 'Inferences on whether low mortality caused high growth in an M=0, Y=1 case given observations on distance and institutions.'
#| echo: false
  conditional_inferences(
    model_rst_pt,   
    parameters = NULL,  
  ...
  slice(1:4) |>
  kabble(digits = 3,  row.names = F, align = "c") 
```
