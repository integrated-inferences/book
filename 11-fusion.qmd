...
kabble(
  cbind(Study = c(1, NA, 2, NA, 3, NA),
    ...
    frank[[2]][,-c(1,3)], 
    frank[[3]][,-c(1,3)])), 
  caption = "Clue $K$ is uninformative in all three studies")
```
...
read_rds("saved/11_fusionestimands.rds") |> 
  ...
  kabble(caption = "Estimands under different assignment schemes", digits = 2)
...
result2 |>
    select(-case_level) |>
kabble(caption = "Effects of $X$ conditional on $X$ for units that were randomly assigned or not.  Effects of $X$ do not depend on $X$ in the experimental group, but they do in the observational group because of self selection. ")
```
