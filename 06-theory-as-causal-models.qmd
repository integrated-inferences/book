...
theorygains |>
  kabble(col.names = c("$q$ (Unobserved)", "$k$ (Observable)", "Event probability (subjective)", "Event probability (objective)", "Inference on $q$ given $k$", "Actual (squared) Error", "Posterior variance"),
         caption = "Possible events, event probabilities, and inferences.", align = "c", escape = TRUE)  |>                   kableExtra::column_spec(1, width = "8em") |>                   kableExtra::column_spec(2, width = "8em")|>                   kableExtra::column_spec(3, width = "8em")|>                   kableExtra::column_spec(4, width = "8em") |>                   kableExtra::column_spec(5, width = "8em") |>                   kableExtra::column_spec(6, width = "8em") |>                   kableExtra::column_spec(7, width = "8em") |>
...
#| fig.align: "center"
#| out.width: '80%'
#| fig.cap :  "Normal form games with expectations and best responses."
...
So far the model does not provide much of an *explanation* for behavior. A lower level causal model might help. In Figure  @fig-HJ-F-6-5, 
...
#| fig.align: "center"
#| out.width: '80%'
#| fig.cap :  "Formal structure of a normal form game (4)."
