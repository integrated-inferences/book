...
```{r}
#| label: tbl-HJ-T-4-2
#| tbl-cap: 'Calculated answers to two queries.'
#| echo: FALSE
df |> summarize(POS = weighted.mean(a1, p),
                 POC = weighted.mean(a1[a2], p[a2])) |> 
  kabble(booktabs = TRUE)
```
...
```{r}
#| label: tbl-HJ-T-4-3
#| tbl-cap: 'Examples of queries and corresponding causal types. The probability of the query is the probability of the causal types that imply the theory.'
#| echo: false
...
```{r}
#| label: tbl-HJ-T-4-4
#| tbl-cap: 'Coefficients on causal types for an interaction query'
#| echo: false
