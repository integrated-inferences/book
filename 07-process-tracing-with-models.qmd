...
#| tbl-cap: 'Nodal types and observed nodal values for a single hypothetical case from an $X \\rightarrow M \\rightarrow Y$ model'
#| echo: false
#| message: false
...
#| tbl-cap: 'Inferences given different clue observations (simple model)'
#| echo: false
if(run)
  query_model(model = model, 
            query = "Y[X=1] > Y[X=0]",
...
#| echo: false
#| message: false
#| tbl-cap: "Data from model with three clues"
...
#| echo: false
#| tbl-cap: "Inferences given different clue observations"
if(run)
  query_model(model = model, 
            query = "Y[X=1] > Y[X=0]",
            given = c("Y==1 & X==1",
