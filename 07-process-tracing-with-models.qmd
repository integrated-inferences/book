...
```{r}
#| label: tbl-ambXMYwpriors
#| eval :  FALSE
#| include :  FALSE
ambXMY_with_priors|>
    mutate(`Causal Type` = rownames(ambXMY_with_priors)) |>
    select(`Causal Type`, X1M0Y0, prior) |>
    filter(X1M0Y0 ==1)|>
...
#| fig.width :  11
#| fig.height :  12
#| fig.cap :  "All connected directed acyclic graphs over $XYKQ$ in which $Q$ is a root node that directly causes $Y$ and $X$ is a direct or indirect cause of $Y$. Graph titles indicate conditions under which $K$ can be informative about $Q$ given prior observation of $X$ $Y$ both or neither (...)."
#| errors :  FALSE
#| warning :  FALSE
#| message :  FALSE
